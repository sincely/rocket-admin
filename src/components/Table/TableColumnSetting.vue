  ...
  <a-popover :placement="placement" :trigger="trigger">
    ...
    <template #title>
      <div class="x-table-column-setting__title">
        <a-checkbox v-model:checked="checkAll" :indeterminate="indeterminate" @change="onCheckboxAllChange">
          列展示/排序
        </a-checkbox>
    ...
    <template #content>
      <vue-draggable
        ...
        @update="onUpdate"
      >
        <div v-for="item in list" :key="item.key" class="x-table-column-setting__item">
          <holder-outlined class="x-table-column-setting__handle j-table-column-setting-handle"></holder-outlined>
          <a-checkbox v-model:checked="item.checked" class="x-table-column-setting__name" @change="onCheckboxChange">
            {{ item.title }}
          </a-checkbox>
        </div>
      </vue-draggable>
